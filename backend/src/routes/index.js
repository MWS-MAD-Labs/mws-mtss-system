...
// and updates EmotionalCheckin/StudentEmotionalCheckin - collections meant
// to be owned by mws-daily-checkin, not written by MTSS directly (see the
// Central-source-of-truth rule: apps don't consume each other's data
// peer-to-peer, only through Central). Commented out rather than deleted
// in case this gets rebuilt through a proper Central-mediated path later.
//
...
router.get('/health', (req, res) => {
    res.status(200).json({
        success: true,
        message: 'MWS MTSS System Backend API is running',
