...
const COMMON_ROUTE_INTENTS = [
    {
        ...
        navigateTo: '/mtss/profile/personal-stats',
    ...
    },
    {
        ...
        navigateTo: '/mtss/profile/emotional-history',
    ...
    },
    {
        ...
        navigateTo: '/mtss/profile/emotional-patterns',
...
const WORKFORCE_ROUTE_INTENTS = [
    ...
    },
    {
        ...
        navigateTo: '/mtss/user-management',
...
export const getAssistantAllowedRoutes = (role = 'student') => {
    ...
    if (['admin', 'superadmin', 'directorate'].includes(normalizedRole)) {
        routes.add('/mtss/user-management');
    }
