...
const publicRoutes = [
    ...
    <Route key="support-hub" path="/support-hub" element={<ProtectedRoute allowedRoles={['staff', 'support_staff', 'nurse', 'counselor', 'teacher', 'se_teacher', 'head_unit', 'principal', 'directorate', 'admin', 'superadmin']}><MtssPreviewGate><MemoizedPageTransition><SupportModeSelectionPage /></MemoizedPageTransition></MtssPreviewGate></ProtectedRoute>} />,
    ...
    <Route key="pilot-testing" path="/pilot-testing" element={<ProtectedRoute allowedRoles={['staff', 'support_staff', 'counselor', 'teacher', 'se_teacher', 'head_unit', 'principal', 'directorate', 'admin', 'superadmin']}><MtssPreviewGate><MemoizedPageTransition><MTSSPilotTestingHubPage /></MemoizedPageTransition></MtssPreviewGate></ProtectedRoute>} />,
    ...
    <Route key="mtss-pilot-testing" path="/mtss/pilot-testing" element={<ProtectedRoute allowedRoles={['staff', 'support_staff', 'counselor', 'teacher', 'se_teacher', 'head_unit', 'principal', 'directorate', 'admin', 'superadmin']}><MtssPreviewGate><MemoizedPageTransition><MTSSPilotTestingHubPage /></MemoizedPageTransition></MtssPreviewGate></ProtectedRoute>} />,
