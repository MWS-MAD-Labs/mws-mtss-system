    ...
    <section className="landing-pointer-shell relative min-h-screen flex items-center justify-center px-4 py-10 md:py-16">
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="landing-gsap-left text-center lg:text-left space-y-6">
          <div
            className="landing-gsap-logo inline-block"
            data-landing-depth="12"
          >
          ...
          <div>
            ...
            <p className="landing-gsap-copy mt-3 text-sm md:text-base lg:text-lg text-foreground/65 max-w-lg leading-relaxed">
              Your gateway to world-class integrated education. AI-powered
              emotional wellness, smart analytics, and personalized learning.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-2">
            {FEATURES.map((f, i) => (
              <span
                key={f.label}
                className="landing-anime-chip inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-card/80 border border-border/40 text-foreground/80 backdrop-blur-sm shadow-sm hover:border-primary/40 hover:shadow-md transition-all duration-300 cursor-default"
                data-aos="zoom-in-up"
                data-aos-delay={90 + i * 70}
        ...
        {/* Right — Auth Card */}
        <div
          className="landing-gsap-card flex justify-center lg:justify-end"
